...
OUTPUT_GLB = OUTPUT_DIR / "STK_HERO_BaseBody_01_Rigged_MeshyMotion_v04.glb"
OUTPUT_REPORT = OUTPUT_DIR / "STK_HERO_BaseBody_01_Rigged_MeshyMotion_v04.export.json"

ARMATURE_NAME = "STK_HERO_BaseBody_01_Armature"
BODY_NAME = "STK_HERO_BaseBody_01_RiggedBody"
ACTION_NAMES = {"STK_WALK", "STK_RUN"}
...
walk = bpy.data.actions["STK_WALK"]
...
report = {
    "schema": "SteamtekHeroRiggedGLBExport-1",
