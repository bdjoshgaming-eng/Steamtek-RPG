...
SOURCE_DIR = ROOT / "output" / "hero_combat_v05" / "review"
OUTPUT_DIR = ROOT / "output" / "hero_combat_v05" / "contact_sheets"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

groups = {}
for path in sorted(SOURCE_DIR.glob("STK_*.png")):
...
for action_name, paths in sorted(groups.items()):
    ...
    output = OUTPUT_DIR / f"{action_name}_contact_sheet.jpg"
...
master_path = OUTPUT_DIR / "STK_HERO_Combat_v05_MasterContactSheet.jpg"
