...
const ITEM_DEFINITIONS: Dictionary = {
	"Piston Blade": {"item_class": "Sword", "item_subclass": "1 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Bleed"}, "weapon_stat_ranges": {"Speed": [2.8, 1.8], "Damage Rating": [8, 16], "Accuracy": [55, 75]}},
	"Piston Greatblade": {"item_class": "Sword", "item_subclass": "2 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Bleed"}, "weapon_stat_ranges": {"Speed": [4.0, 3.0], "Damage Rating": [18, 32], "Accuracy": [40, 60]}},
	"Pressure Maul": {"item_class": "Hammer", "item_subclass": "2 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Crush"}, "weapon_stat_ranges": {"Speed": [4.5, 3.2], "Damage Rating": [20, 36], "Accuracy": [35, 55]}},
	"Arc Rod": {"item_class": "Stun Stick", "item_subclass": "1 Handed", "weapon_categorical_stats": {"Damage Type": "Arc", "Wound Type": "Stun"}, "weapon_stat_ranges": {"Speed": [2.4, 1.6], "Damage Rating": [6, 14], "Accuracy": [55, 75]}},
	"Riveted Knuckles": {"item_class": "Brass Knuckles", "item_subclass": "1 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Bruise"}, "weapon_stat_ranges": {"Speed": [1.8, 1.0], "Damage Rating": [5, 12], "Accuracy": [65, 85]}},
	...
	"Rusty Pistol": {"item_class": "Pistol", "item_subclass": "Pistol", "weapon_categorical_stats": {"Damage Type": "Ballistic", "Wound Type": "Puncture"}, "weapon_stat_ranges": {"Speed": [1.2, 0.6], "Damage Rating": [6, 14], "Range": [15, 25], "Ammo Capacity": [8, 15], "Reload Speed": [3.0, 1.5], "Accuracy": [65, 85]}},
	"Pneumatic Rifle": {"item_class": "Assault Rifle", "item_subclass": "Assault Rifle", "weapon_categorical_stats": {"Damage Type": "Ballistic", "Wound Type": "Puncture"}, "weapon_stat_ranges": {"Speed": [0.4, 0.15], "Damage Rating": [8, 18], "Range": [40, 70], "Ammo Capacity": [20, 35], "Reload Speed": [3.5, 2.0], "Accuracy": [45, 65]}},
	"Pneumatic Longrifle": {"item_class": "Sniper Rifle", "item_subclass": "Sniper Rifle", "weapon_categorical_stats": {"Damage Type": "Ballistic", "Wound Type": "Puncture"}, "weapon_stat_ranges": {"Speed": [3.0, 1.8], "Damage Rating": [30, 55], "Range": [100, 160], "Ammo Capacity": [4, 8], "Reload Speed": [4.0, 2.5], "Accuracy": [70, 90]}},
	"Pressure Scattergun": {"item_class": "Shotgun", "item_subclass": "Shotgun", "weapon_categorical_stats": {"Damage Type": "Ballistic", "Wound Type": "Laceration"}, "weapon_stat_ranges": {"Speed": [3.5, 2.5], "Damage Rating": [22, 38], "Range": [8, 15], "Ammo Capacity": [4, 8], "Reload Speed": [5.0, 3.5], "Accuracy": [35, 55]}},
	"Canister Launcher": {"item_class": "Grenade Launcher", "item_subclass": "Grenade Launcher", "weapon_categorical_stats": {"Damage Type": "Pressure", "Wound Type": "Blast"}, "weapon_stat_ranges": {"Speed": [3.5, 2.2], "Damage Rating": [50, 90], "Range": [30, 60], "Ammo Capacity": [1, 4], "Reload Speed": [5.0, 3.0], "Accuracy": [35, 55]}},
	"Oil Burner": {"item_class": "Flame Thrower", "item_subclass": "Flame Thrower", "weapon_categorical_stats": {"Damage Type": "Thermal", "Wound Type": "Burn"}, "weapon_stat_ranges": {"Speed": [0.3, 0.1], "Damage Rating": [5, 10], "Range": [5, 12], "Ammo Capacity": [50, 100], "Reload Speed": [4.5, 3.0], "Accuracy": [50, 70]}},
	"Hydraulic Saber": {"item_class": "Sword", "item_subclass": "1 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Bleed"}, "weapon_stat_ranges": {"Speed": [2.4, 1.5], "Damage Rating": [14, 26], "Accuracy": [60, 80]}},
	"Compression Sledge": {"item_class": "Hammer", "item_subclass": "2 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Crush"}, "weapon_stat_ranges": {"Speed": [3.6, 2.4], "Damage Rating": [30, 50], "Accuracy": [40, 60]}},
	"Pneumatic Knuckles": {"item_class": "Brass Knuckles", "item_subclass": "1 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Bruise"}, "weapon_stat_ranges": {"Speed": [1.5, 0.8], "Damage Rating": [9, 18], "Accuracy": [70, 90]}},
	"Steam Baton": {"item_class": "Baton", "item_subclass": "1 Handed", "weapon_categorical_stats": {"Damage Type": "Kinetic", "Wound Type": "Bruise"}, "weapon_stat_ranges": {"Speed": [2.2, 1.4], "Damage Rating": [12, 22], "Accuracy": [60, 80]}},
	"Vented Long-Rifle": {"item_class": "Sniper Rifle", "item_subclass": "Sniper Rifle", "weapon_categorical_stats": {"Damage Type": "Ballistic", "Wound Type": "Puncture"}, "weapon_stat_ranges": {"Speed": [2.6, 1.5], "Damage Rating": [45, 75], "Range": [120, 190], "Ammo Capacity": [5, 10], "Reload Speed": [3.5, 2.2], "Accuracy": [75, 95]}},
	"Double-Bore Scattergun": {"item_class": "Shotgun", "item_subclass": "Shotgun", "weapon_categorical_stats": {"Damage Type": "Ballistic", "Wound Type": "Laceration"}, "weapon_stat_ranges": {"Speed": [4.5, 3.2], "Damage Rating": [35, 60], "Range": [10, 18], "Ammo Capacity": [2, 4], "Reload Speed": [6.0, 4.5], "Accuracy": [35, 55]}},
	"Copper Lined Gun": {"item_class": "Pistol", "item_subclass": "Pistol", "weapon_categorical_stats": {"Damage Type": "Ballistic", "Wound Type": "Puncture"}, "weapon_stat_ranges": {"Speed": [1.0, 0.5], "Damage Rating": [10, 22], "Range": [20, 32], "Ammo Capacity": [10, 18], "Reload Speed": [2.5, 1.2], "Accuracy": [70, 90]}},
	"Pressure-Fed Launcher": {"item_class": "Grenade Launcher", "item_subclass": "Grenade Launcher", "weapon_categorical_stats": {"Damage Type": "Pressure", "Wound Type": "Blast"}, "weapon_stat_ranges": {"Speed": [3.0, 1.8], "Damage Rating": [65, 105], "Range": [35, 65], "Ammo Capacity": [2, 5], "Reload Speed": [4.5, 2.8], "Accuracy": [40, 60]}},
}
